...
require_relative '01_easy1_q08_word_count'
...
class PhraseTest < Minitest::Test
  ...
  def test_with_quote_only_at_end
    phrase = Phrase.new("Incomin' 'random \"phrase\" with Louis' 'friends'")
    counts = {
      "incomin'" =>1, 'random' => 1, "phrase" => 1, 'with' => 1, "louis'" => 1,
      'friends' => 1
    }
    assert_equal counts, phrase.word_count
  end
